//
//  AppDataGathererExportAudit1DetailsView.swift
//  PMADataGatherer
//
...
struct AppDataGathererExportAudit1DetailsView: View 
{
    
    struct ClassInfo
    {
        
        static let sClsId        = "AppDataGathererExportAudit1DetailsView"
            ...
            VStack(alignment:.center)
            {
                ...
                HStack(alignment:.center)
                {
                    ...
                    Button
                    {
                        ...
                        let _ = xcgLogMsg("\(ClassInfo.sClsDisp):AppDataGathererExportAudit1DetailsView.Button(Xcode).'Dismiss' pressed...")
...
}   // End of struct AppDataGathererExportAudit1DetailsView(View).
