//
//  AppDataGathererSchedule1ExportView.swift
//  PMADataGatherer
//
...
struct AppDataGathererSchedule1ExportView: View 
{
            ...
            VStack
            {
                ...
                HStack(alignment:.center)
                {
                    ...
                    Button
                    {
                        ...
                        let _ = xcgLogMsg("\(ClassInfo.sClsDisp):AppDataGathererSchedule1ExportView.Button(Xcode).'Dismiss' pressed...")
                ...
                HStack()
                {
                        ...
                        self.sTherapistTID       != "-1")
                    {
                        ...
                        Button
                        {
                            ...
                            let _ = xcgLogMsg("\(ClassInfo.sClsDisp):AppDataGathererSchedule1ExportView.Button(Xcode).'ALL Therapist(s)' pressed...")
        ...
        //  {
                ...
                HStack
                {
                    ...
                    Button
                    {
                        ...
                        let _ = self.xcgLogMsg("\(ClassInfo.sClsDisp)AppDataGathererSchedule1ExportView in Button(Xcode).'Export the Schedule' for TID 'self.sTherapistTID' of [\(self.sTherapistTID)]...")
                    ...
                    //  .toggleStyle(SwitchToggleStyle())
                        ...
                        HStack()
                        {
                            ...
                            TextField("TherapistTID...", text:$sTherapistTID)
                                ...
                                .onAppear
                                {
                                    let _ = self.xcgLogMsg("\(ClassInfo.sClsDisp).AppDataGathererSchedule1ExportView.TextField #1 - Received an .onAppear() #1...")
                            ...
                            Button
                            {
                                ...
                                let _ = self.xcgLogMsg("\(ClassInfo.sClsDisp)AppDataGathererSchedule1ExportView.Button(Xcode).'Therapist TID delete'...")
...
}   // End of struct AppDataGathererSchedule1ExportView(View).
