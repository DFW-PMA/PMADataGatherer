...
//  #endif
    ...
    private func downloadAppReleaseUpdate()
    {
        ...
        let urlToOpen:URL = URL(string:"itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/DFW-PMA/PMADataGatherer/refs/heads/main/PMADataGatherer.plist")!
    ...
    private func downloadAppPreReleaseUpdate()
    {
        ...
        let urlToOpen:URL = URL(string:"itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/DFW-PMA/PMADataGatherer/refs/heads/main/PMADataGatherer_Pre.plist")!
